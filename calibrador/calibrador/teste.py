def encontrar_digitos(linha):
    ...
    while i < n:
        if linha[i:i+3] == "one":
            ...
            i += 3
        elif linha[i:i+3] == "two":
            numeros_encontrados.append("2")
            i += 3
        elif linha[i:i+5] == "three":
            numeros_encontrados.append("3")
            i += 5
        elif linha[i:i+4] == "four":
            numeros_encontrados.append("4")
            i += 4
        elif linha[i:i+4] == "five":
            numeros_encontrados.append("5")
            i += 4
        elif linha[i:i+3] == "six":
            numeros_encontrados.append("6")
            i += 3
        elif linha[i:i+5] == "seven":
            numeros_encontrados.append("7")
            i += 5
        elif linha[i:i+5] == "eight":
            numeros_encontrados.append("8")
            i += 5
        elif linha[i:i+4] == "nine":
            numeros_encontrados.append("9")
            i += 4
